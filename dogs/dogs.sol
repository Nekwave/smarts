...
contract NewGG is Ownable, ERC721A, ERC721AQueryable, RevokableDefaultOperatorFilterer, ERC721ABurnable, ReentrancyGuard {
    // metadata URI
    ...
    address public oldSmartAddress;
    Old public OldSmart;
    mapping(address => bool) private _disabledMarkets;
    ...
    RevokableDefaultOperatorFilterer()
    {
        ...
        oldSmartAddress = 0x000000000000000000000000000000000000dEaD;
        priceWei = 0.05 ether;
    }
    ...
    function transferFrom(address from, address to, uint256 tokenId) public payable override(ERC721A, IERC721A) onlyAllowedOperator(from) {
        require(_disabledMarkets[msg.sender]!=true,'Marketplace was blocked');
    ...
    function sudoUpdateOldSmartAddress(
        address _oldSmartAddress
    )
    onlyOwner
    public
    {
        oldSmartAddress = _oldSmartAddress;
        OldSmart = Old(oldSmartAddress);
    }
    function sudoUpdateCollectionSize(
        uint256 size
    )
    onlyOwner
    public
    ...
    function blockMarket(address _address, bool _isBlocked) external onlyOwner {
        _disabledMarkets[_address] = _isBlocked;
    }
    ...
    callerIsUser
    {
        OldSmart.transferFrom(msg.sender, address(0x000000000000000000000000000000000000dEaD), tokenId);
        _targetMint(msg.sender, tokenId); 
    }
    function mint(
        uint256 quantity,
